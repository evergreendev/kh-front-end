...
const TopBar = ({siteOption, nav}: { siteOption: SiteOption, nav: Navigation }) => {
    ...
    return <div className="flex flex-wrap max-w-screen-2xl w-full justify-end lg:justify-between items-center">
        ...
        <div className="flex-col ml-auto mb-4 lg:mb-0 lg:ml-0 w-full sm:w-auto items-end lg:items-start hidden lg:flex">
            <MegaMenu nav={nav}/>
