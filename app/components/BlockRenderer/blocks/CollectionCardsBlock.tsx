...
import {Media, MuseumCollection, Page} from "@/app/types/payloadTypes";
...
function getImage(item: Page | MuseumCollection): Media | null {
...
function getSlugFromCollection(item: (Page | MuseumCollection), collectionSlug: string): string {
