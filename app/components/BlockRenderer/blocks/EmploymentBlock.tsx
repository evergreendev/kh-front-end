            ...
            return <div key={position.id} className="flex flex-wrap border border-slate-400 border-l-transparent border-r-transparent py-2">
                ...
                <div className="w-8/12 grow flex flex-col min-h-24">
                    ...
                    <div className="ml-auto mt-auto">
                        <Button isExternal={position.linksToOnlineEmploymentForm} config={buttonConfig.tertiary} icon={faChevronCircleRight} text="Click Here to Apply" href={(position.linksToOnlineEmploymentForm ? "/employment-application":(position.PDF as Media).url)||""}/>
                    </div>
                </div>
            </div>
        })}
